...
#include<sstream>                           // 文件输入输出
#include<string>                            // string
#include"View.hpp"                          // View声明
#include"../Controller/ControllerBase.hpp"  // 控制器基类
#include"../Controller/ControllerCLI.hpp"   // 控制器命令行类

std::string DEFAULT_PATH = 
    "/home/zzpku/myCode/OOP/Construct3DWorld/data/cube.obj";

/*************************************************************************
【函数名称】       View
【函数功能】       构造View类实例，初始化并获取Controller的单例
【参数】           无
【返回值】         无
【开发者及日期】  张章 2024-7-31
【更改记录】       无
...
std::string View::MainMenu(){
    ...
    while (command != ":wq"){
        ...
        std::cout << 
        "         - type  :import<Enter>          Skip to import menu" 
        << std::endl << std::endl;

        std::cout << 
        "         - type  :export<Enter>          Skip to export menu"   
        << std::endl << std::endl;

        std::cout << 
        "         - type  :model<Enter>           Skip to model menu" 
        << std::endl << std::endl;

        std::cout << 
        "         - type  :display<Enter>         Skip to display menu"      
        << std::endl << std::endl;

        std::cout << 
        "         - type  :modify<Enter>          Skip to modify menu"
        << std::endl << std::endl;
...
/*************************************************************************
【函数名称】       ImportMenu
【函数功能】       展示导入菜单界面并处理用户输入
【参数】           无
【返回值】         std::string: 导入菜单的提示信息
【开发者及日期】  张章 2024-7-31
【更改记录】       无
*************************************************************************/
std::string View::ImportMenu(){
    ...
    while(command != ":q"){
        ...
        << std::endl << std::endl;
        std::cout << 
        "         - type  :default                   Import default model"     
        << std::endl << std::endl;
        std::cout << 
        "         - type  [path/to/model]<Enter>    Import the model"       
        << std::endl << std::endl;
        std::cout << 
        "         - type  :q<Enter>                 Return to main menu"      
        << std::endl << std::endl;
        std::cout << 
        "       ----------------------------------------------------------"   
        << std::endl << std::endl;
...
/*************************************************************************
【函数名称】       ExportMenu
【函数功能】       展示导出菜单界面并处理用户输入
【参数】           无
【返回值】         std::string: 导出菜单的提示信息
【开发者及日期】  张章 2024-7-31
【更改记录】       无
*************************************************************************/
std::string View::ExportMenu(){
    ...
    while(command != ":q"){
        std::cout << 
        "       -----------------Export the model you want!---------------"   
        << std::endl << std::endl;

        std::cout << 
        "         - type  [path/to/model]<Enter>    Export the model"         
        << std::endl << std::endl;
...
/*************************************************************************
【函数名称】       ModelMenu
【函数功能】       展示模型菜单界面并处理用户输入，包括列出所有模型、
                   激活模型等操作
【参数】           无
【返回值】         std::string: 模型菜单的提示信息
【开发者及日期】   张章 2024-7-31
【更改记录】       无
*************************************************************************/
std::string View::ModelMenu(){
    ...
    while(command != ":q"){
        ...
        std::cout << 
        "         - type  :ls<Enter>                Show all models"          
        << std::endl << std::endl;

        std::cout << 
        "         - type  :activate [idx]<Enter>    Choose a model"           
        << std::endl << std::endl;
        ...
        // 激活指定模型
            ...
            if (num >> ModelIdx){
                ...
                std::cout << 
                "invalid argument, please type the index of model, " 
                << std::endl;
            }
        }
        // 命令非法
...
/*************************************************************************
【函数名称】       DisplayMenu
【函数功能】       展示显示菜单界面并处理用户输入，包括显示面、线和统计信息
                   等操作
【参数】           无
【返回值】         std::string: 显示菜单的提示信息
【开发者及日期】  张章 2024-7-31
【更改记录】       无
**************************************************************************/
std::string View::DisplayMenu(){
    ...
    while (command != ":wq"){
        ...
        std::cout << 
        "         - type  :face<Enter>              Data about Faces"       
        << std::endl << std::endl;

        std::cout << 
        "         - type  :line<Enter>              Data about Lines"       
        << std::endl << std::endl;

        std::cout << 
        "         - type  :total<Enter>             Statistical data"       
        << std::endl << std::endl;

        std::cout << 
        "         - type  :wq<Enter>                Return to main menu."   
        << std::endl << std::endl;
...
/*************************************************************************
【函数名称】       ModifyMenu
【函数功能】       展示修改菜单界面并处理用户输入，包括添加、删除和修改面和线等操作
【参数】           无
【返回值】         std::string: 修改菜单的提示信息
【开发者及日期】  张章 2024-7-31
【更改记录】       无
*************************************************************************/
std::string View::ModifyMenu (){
    ...
    while (command != ":wq"){
        std::cout << 
        "       ----------------Modify Whatever U Need!----------------"     
        << std::endl << std::endl;

        std::cout << 
        "         - type  :face<Enter>              Modify Faces"           
        << std::endl << std::endl;

        std::cout << 
        "         - type  :line<Enter>              Modify Lines"
        << std::endl << std::endl;
        std::cout << 
        "         - type  :wq<Enter>                Return to Main Menu"
        << std::endl << std::endl;
...
【函数名称】       ShowFaceInfo
【函数功能】       显示指定面的详细信息
【参数】           const FaceDetail& face_info: 输入参数，要显示的面的详细信息
【返回值】         无
【开发者及日期】  张章 2024-7-31
【更改记录】       无
*************************************************************************/
...
【函数名称】       ShowLineInfo
【函数功能】       显示指定线的详细信息
【参数】           const LineDetail& line_info: 输入参数，要显示的线的详细信息
【返回值】         无
【开发者及日期】  张章 2024-7-31
【更改记录】       无
*************************************************************************/
...
/*************************************************************************
【函数名称】       ShowStatisticalInfo
【函数功能】       显示模型的统计信息
【参数】           const StatisticalInfo& info: 输入参数，要显示的统计信息
【返回值】         无
【开发者及日期】  张章 2024-7-31
【更改记录】       无
*************************************************************************/
void View::ShowStatisticalInfo(const StatisticalInfo& info){
    std::cout << "Name of model: "
    << info.Name              << std::endl
              << "Number of faces: "
    << info.FaceNum           << std::endl
              << "Number of lines: "
    << info.LineNum           << std::endl
              << "Number of points: "
    << info.PointNum          << std::endl
              << "Volume of bounding box:"      
    << info.BoundingBoxVolume << std::endl
              << "Total area of all faces: "    
    << info.FaceArea          << std::endl
              << "Total length of all lines: " 
    << info.LineLength        << std::endl;
}


/*************************************************************************
【函数名称】       DisplayFace
【函数功能】       面显示的菜单，辅助DisplayMenu
【参数】           std::string& command: 和DisplayMenu共用的命令，输入参数
【返回值】         无
【开发者及日期】   张章 2024-7-31
【更改记录】       无
*************************************************************************/
void View::DisplayFace(std::string& command){
    std::cout << 
    "       ----------------What about Faces do U want?---------------" 
    << std::endl << std::endl;

    std::cout << 
    "         - type  :ls<Enter>             List all faces' info" 
    << std::endl << std::endl;

    std::cout << 
    "         - type  :ls [idx]<Enter>       List info of ith face" 
    << std::endl << std::endl;
    ...
    if (command.substr(0, 3) == ":ls"){
        ...
        if (num >> FaceIdx){
            ...
            if(Msg == ControllerReturn::INDEX_OUT_OF_RANGE){
                std::cout << 
                "wrong idx! check your input!" << std::endl;
            }
            ...
            if      (Msg == ControllerReturn::NO_MODEL){
                std::cout << 
                "you don't even activated a model." 
                << std::endl;
            }
...
/*************************************************************************
【函数名称】       DisplayLine
【函数功能】       线显示的菜单，辅助DisplayMenu
【参数】           std::string& command: 和DisplayMenu共用的命令，输入参数
【返回值】         无
【开发者及日期】   张章 2024-7-31
【更改记录】       无
*************************************************************************/
void View::DisplayLine(std::string& command){
    std::cout << 
    "       ----------------What about Lines do U want?----------------"
    << std::endl << std::endl;

    std::cout << 
    "         - type  :ls<Enter>             List all lines' info" 
    << std::endl << std::endl;

    std::cout << 
    "         - type  :ls [idx]<Enter>       List info of ith line"
    << std::endl << std::endl;
    ...
    if (command.substr(0, 3) == ":ls"){
        ...
        if (num >> LineIdx){
            ...
            ControllerReturn Msg =
                m_ptrController->GetLineInfo(LineIdx, line_info);
            if(Msg == ControllerReturn::INDEX_OUT_OF_RANGE){
                std::cout << 
                "wrong idx! check your input!" << std::endl;
            }
            ...
            if      (Msg == ControllerReturn::NO_MODEL){
                std::cout << 
                "you don't even have a model." << std::endl;
            }
            else if (Msg == ControllerReturn::NO_LINES){
                std::cout << 
                "you don't even have a line." << std::endl;
            }
...
/*************************************************************************
【函数名称】       ModifyLine
【函数功能】       面修改的菜单，辅助ModifyMenu的功能
【参数】           const StatisticalInfo& info: 输入参数，要显示的统计信息
【返回值】         无
【开发者及日期】  张章 2024-7-31
【更改记录】       无
*************************************************************************/
void View::ModifyFace (std::string& command){
    std::cout << 
    "       ----------------How do you want to modify?----------------"
    << std::endl << std::endl;

    std::cout << 
    "         - type  :add [coordinates x 3]<Enter> "
    << std::endl << std::endl;
    ...
    std::cout << 
    "         - type  :modify [idx1] [idx2] [coordinate]<Enter> "
    << std::endl << std::endl;

    std::cout << 
    "                 Modify idx2th point of idx1th face"
    << std::endl << std::endl;
    ...
    if(command.substr(0, 4) == ":add"){
        ...
        if (coordinates.size() == 9){
            ...
            if (Msg == ControllerReturn::FACE_REPEATED){
                std::cout << 
                "the face you want to add already exist." << std::endl;
            }
            else if (Msg == ControllerReturn::POINTS_REPEATED){
                std::cout << 
                "the points of a face shouldn't be repeated." 
                << std::endl;
            }
            else if (Msg == ControllerReturn::FACE_ADDED){
                std::cout << 
                "the face are added successfully!" << std::endl;
            }
        }
        else{
        ...
        if (iss >> idx){
            ...
            if (Msg == ControllerReturn::FACE_DELETED){
                std::cout << 
                "the face is deleted successfully." << std::endl;
            }
            else if(Msg == ControllerReturn::INDEX_OUT_OF_RANGE){
                std::cout << 
                "the index provided is out of range." << std::endl;
            }
        }
        else{
            std::cout << 
            "please enter the index of a face." << std::endl;
        }
    }
        ...
        double y        = 0.0;
        double z        = 0.0;
        if (iss >> FaceIdx && iss >> PointIdx && 
            iss >> x && iss >> y && iss >> z){
            ControllerReturn Msg;
            Msg = m_ptrController->ModifyPointOfFace(
                        FaceIdx, PointIdx, x, y, z
                    );
            if (Msg == ControllerReturn::POINT_OF_FACE_CHANGED){
                std::cout << "The point " << PointIdx << " of " << 
                FaceIdx << " face has been changed successfully." << 
                std::endl;
            }
            else if (Msg == ControllerReturn::INDEX_OUT_OF_RANGE){
                std::cout << 
                ...
                std::cout << "A face shouldn't has repeated face." 
                << std::endl;
            }
        }
        else{
...
/*************************************************************************
【函数名称】       ModifyLine
【函数功能】       线修改的菜单，辅助ModifyMenu的功能
【参数】           const StatisticalInfo& info: 输入参数，要显示的统计信息
【返回值】         无
【开发者及日期】  张章 2024-7-31
【更改记录】       无
*************************************************************************/
void View::ModifyLine (std::string& command){
    std::cout << 
    "       ----------------How do you want to modify?----------------" 
    << std::endl << std::endl;

    std::cout << 
    "         - type  :add [coordinates x 2]<Enter> "
    << std::endl << std::endl;
    ...
    std::cout << 
    "                 Modify idx2th point of idx1th line"
    << std::endl << std::endl;
    ...
    if(command.substr(0, 4) == ":add"){
        ...
        if (coordinates.size() == 6){
            ControllerReturn Msg;
            Msg = m_ptrController->AddLine(
                    coordinates[0], coordinates[1], coordinates[2], 
                    coordinates[3], coordinates[4], coordinates[5]);
            if (Msg == ControllerReturn::LINE_REPEATED){
                std::cout << 
                "the line you want to add already exist." << std::endl;
            }
            else if (Msg == ControllerReturn::POINTS_REPEATED){
                std::cout << 
                "the points of a line shouldn't be repeated." 
                << std::endl;
            }
            else if (Msg == ControllerReturn::LINE_ADDED){
                std::cout << 
                "the line are added successfully!" << std::endl;
            }
        }
        else{
            std::cout << "missing arguments." << std::endl;
        ...
        if (iss >> idx){
            ...
            if (Msg == ControllerReturn::LINE_DELETED){
                std::cout << 
                "the line is deleted successfully." << std::endl;
            }
            else if(Msg == ControllerReturn::INDEX_OUT_OF_RANGE){
                std::cout << 
                "the index provided is out of range." << std::endl;
            ...
            std::cout << 
            "please enter the index of a line." << std::endl;
        }
    }
    else if (command.substr(0, 7) == ":modify"){
        std::istringstream iss(command.substr(7));
        ...
        double y        = 0.0;
        double z        = 0.0;
        if (iss >> lineIdx && iss >> PointIdx && 
            iss >> x && iss >> y && iss >> z){
            ControllerReturn Msg;
            Msg = m_ptrController->ModifyPointOfLine(
                    lineIdx, PointIdx, x, y, z);
            if (Msg == ControllerReturn::POINT_OF_LINE_CHANGED){
                std::cout << "The point " << PointIdx << " of " << 
                lineIdx << " line has been changed successfully." 
                << std::endl;
            }
            else if (Msg == ControllerReturn::INDEX_OUT_OF_RANGE){
                std::cout << 
                ...
                std::cout << 
                "A line shouldn't has repeated line." << std::endl;
            }
        }
        else{
            std::cout << "invalid argument." << std::endl;
